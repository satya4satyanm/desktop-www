...
var screenInfo, screenSplash, screenSetup, mainMenuContainer, screenDropInside, screenCategory, screenGallery, screenRotate, screenSize, screenResult, screenConfirm, header;
...
function init() {
    ...
    */
    ...
    addText("lblSplashTitle", mainMenu, "Jigsaw Puzzle", "Berlin Sans FB Demi", 35, "#000000", "c", 10);

    Button("btnPlay", mainMenu, "roundrect", "#994400", "rgba(0,0,0,0)", 0, "TL", 10, 5, "Play", "Berlin Sans FB", 25, "#ffffff", "", 2, "c", 120, true);

    Button("btnOptions", mainMenu, "roundrect", "#994400", "rgba(0,0,0,0)", 0, "TL", 10, 5, "Options", "Berlin Sans FB", 25, "#ffffff", "", 2, "c", 240, true);

    Button("btnStatistics", mainMenu, "roundrect", "#994400", "rgba(0,0,0,0)", 0, "TL", 10, 5, "Statistics", "Berlin Sans FB", 25, "#ffffff", "", 2, "c", 360, true);

    Button("btnAbout", mainMenu, "roundrect", "#994400", "rgba(0,0,0,0)", 0, "TL", 10, 5, "About", "Berlin Sans FB", 25, "#ffffff", "", 2, "c", 480, true);
    ...
    addText("lblOptionsTitle", setupBox, "Options", "Berlin Sans FB Demi", 35, "#000000", "c", 10);


    Radio("join", setupBox, "TL", "Join:", ["Free", "Position"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 105, true);
    Radio("throw", setupBox, "TL", "Throw:", ["All", "Single"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 150, true);
    Radio("colorshift", setupBox, "TL", "Color Shift:", ["Yes", "No"], 1, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 195, true);
    Radio("rotation", setupBox, "TL", "Rotation:", ["Yes", "No"], 1, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 240, true);
    Radio("time", setupBox, "TL", "Time:", ["Elapse", "Limit"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 285, true);
    Radio("hint", setupBox, "TL", "Hint:", ["Yes", "No"], 1, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 285, false);
    Radio("shuffle", setupBox, "TL", "Shuffle:", ["1", "2", "3", "4"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 330, true);
    Radio("shape", setupBox, "TL", "Shape:", ["1", "2", "3"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 375, true);
    if (device == "smart") {
        Radio("image", setupBox, "TL", "Image:", ["Gallery", "Camera"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 420, false);
    } else {
        Radio("image", setupBox, "TL", "Image:", ["Gallery", "Drop Inside"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 420, false);
    }

    Button("btnOptionsOk", setupBox, "roundrect", "#994400", "rgba(0,0,0,0)", 0, "TL", 10, 5, "Ok", "Berlin Sans FB", 25, "#ffffff", "", 2, "c", 480, true);
