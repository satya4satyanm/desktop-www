...
From inside the game when option is opened I need to map the radios from image config in LS


localStorage keys
-treecardgames.jigsaw.games.deers
-treecardgames.jigsaw.options