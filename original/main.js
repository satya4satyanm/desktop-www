...
var screenInfo, screenSplash, screenSetup, screenDropInside, screenCategory, screenGallery, screenRotate, screenSize, screenResult, screenConfirm, header;
...
function init() {
    ...
    */
    ...
    Radio("colorshift", setupBox, "TL", "Color Shift:", ["Yes", "No"], 1, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 150);
    Radio("rotation", setupBox, "TL", "Rotation:", ["Yes", "No"], 1, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 195);
    Radio("time", setupBox, "TL", "Time:", ["Elapse", "Limit"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 240);
    Radio("hint", setupBox, "TL", "Hint:", ["Yes", "No"], 1, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 285);
    Radio("shuffle", setupBox, "TL", "Shuffle:", ["1", "2", "3", "4"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 330);
    Radio("shape", setupBox, "TL", "Shape:", ["1", "2", "3"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 375);
    if (device == "smart") {
        Radio("image", setupBox, "TL", "Image:", ["Gallery", "Camera"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 420);
    } else {
        Radio("image", setupBox, "TL", "Image:", ["Gallery", "Drop Inside"], 0, "rgba(255,0,0,0)", .5, "#000000", "#000000", "Berlin Sans FB", "#000000", (device == "smart") ? 1 : 1.5, "c", 420);
    }
    Button("btnPlay", setupBox, "roundrect", "#994400", "rgba(0,0,0,0)", 0, "TL", 10, 5, "Play", "Berlin Sans FB", 25, "#ffffff", "", 2, "c", 480, true);
